...
(function () {
  ...
  var DICT = {
    ...
    "Наведи на точку — увидишь базовый пинг до узла из России.": "Hover over a dot to see the baseline ping from Russia to that node.",
    "Инфраструктура": "Infrastructure", "7 узлов · 6 CDN-рельсов": "7 nodes · 6 CDN rails", "Загрузка сети": "Network load", "Средний пинг": "Average ping",
    ...
    "// инфраструктура": "// infrastructure", "Серверы,": "Servers", "которые на связи": "that are online",
    "Базовый пинг из России до каждого из 7 узлов сети и среднее по флоту.":
      "Baseline ping from Russia to each of the 7 network nodes and the fleet average.",
    "📈 Базовый пинг по узлам · из России": "📈 Baseline ping by node · from Russia",
    "🏆 Лидеры по пингу": "🏆 Ping leaders", "сеть онлайн 24/7": "network online 24/7",
    "Москва": "Moscow", "Хельсинки": "Helsinki", "Париж": "Paris", "Варшава": "Warsaw",
    "Гонконг": "Hong Kong", "Бухарест": "Bucharest", "Рейкьявик": "Reykjavik", "Амстердам": "Amsterdam",
    // b-box
    ...
    "Количество": "Quantity", "← На главную": "← Home", "Закажи": "Order",
    ...
    "топ-5": "top-5", "топ-3": "top-3", "Не удалось отправить заявку — проверь интернет и попробуй ещё раз. Или напиши нам:": "Couldn't send the request — check your connection and try again. Or message us:", "· приватность без компромиссов": "· privacy without compromise",
    // attrs
    ...
    "закрыть": "close", "@username или +7…": "@username or +1…",
    ...
    // app.html — страница скачивания / Happ
